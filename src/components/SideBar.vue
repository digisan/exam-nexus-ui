<template>
    <aside :class="[
        ...
        <!-- 收起/展开按钮 -->
        <button @click="isCollapsed = !isCollapsed" class="absolute top-1/2 -translate-y-1/2 right-[-12px] w-6 h-16 bg-gray-100 border-none rounded-r-lg flex items-center justify-center hover:bg-gray-200 transition">
            <!-- SVG 图标 -->
